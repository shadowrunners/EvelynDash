...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
	...
	const items = [
		{
			title: 'Anti-Phishing',
			url: `/guilds/${id}/features/antiphishing`,
			icon: FishOff,
		},
		{
			title: 'AutoMod',
			url: `/guilds/${id}/features/automod`,
			icon: Shield,
		},
		{
			title: 'Confessions',
			url: `/guilds/${id}/features/confessions`,
			icon: MailQuestion,
		},
		{
			title: 'Goodbye',
			url: `/guilds/${id}/features/goodbye`,
			icon: MessageSquare,
		},
		{
			title: 'Levelling',
			url: `/guilds/${id}/features/levelling`,
			icon: Diff,
		},
		{
			title: 'Moderation Logs',
			url: `/guilds/${id}/features/logs`,
			icon: Scroll,
		},
		{
			title: 'Tickets',
			url: `/guilds/${id}/features/tickets`,
			icon: Ticket,
		},
		{
			title: 'Welcome',
			url: `/guilds/${id}/features/welcome`,
			icon: MessageSquare,
		},
	];
